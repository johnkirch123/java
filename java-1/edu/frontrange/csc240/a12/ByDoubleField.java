...
/**
 * A comparator to order by the given double field of a state or territory. If 
 * the double values are equal, then the ordering is done by the natural 
 * ordering of the AreaData object.
 * <p>
 ...
 */
public class ByDoubleField implements Comparator<AreaData>
{
/**
 ...
 */
public ByDoubleField(Fields field)
{
	this.field = field;
}
